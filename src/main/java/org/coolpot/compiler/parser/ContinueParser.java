...
public class ContinueParser implements SubParser{
    Token match;
    Parser parser;
    SourceFile file;

    public ContinueParser(SourceFile file, Parser parser){
        this.match = new Token(Token.Type.KEY,"continue",0,file);
        this.parser = parser;
        this.file = file;
    }
